                ...
                <div class="form-billing-details">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="sg_business_name" value="{{ $order->sg_business_name }}"
                                    placeholder="Business Name" required="" class="form-control sg_business_name" />
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
                            <div class="form-group">
                        ...
                        <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
                            <div class="form-group">
                                <label>Address</label>
                                <input type="text" placeholder="Address" value="{{ $order->sg_business_address }}"
                        ...
                        <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
                            <div class="form-group">
                                <label>Email</label>
                                <input type="email" name="sg_business_email" value="{{ $order->sg_business_email }}"
                                    placeholder="Email" required="" class="form-control sg_business_email" />
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
                            <div class="form-group">
                                <label>Phone Number</label>
                                <input type="number" name="sg_business_phone" value="{{ $order->sg_business_phone }}"
                                    placeholder="Phone Number" required="" class="form-control sg_business_phone" />
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
                            <div class="form-group">
                ...
                <div class="col-md-12">
                    ...
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <td align="right">
                                <input type="text" name="discounted_price" value="{{ $order->discounted_price }}"
                                    readonly class="discounted_price custominput">&#8377;
                            </td>
                        </tr>
                        <tr>
...
<div class="row mb-3 ml-3 mr-3 mt-3">
    <div class="col-md-12">
        ...
        @else
            ...
            <a href="{{ url('/view-invoice/' . $order->id) }}" type="button" class="btn btn-info">View Invoice</a>
        @endif
    </div>
</div>
