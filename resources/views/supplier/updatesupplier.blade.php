    ...
    <div class="row mb-3 ml-3 mr-3 mt-3">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="text" name="supplier_company" value="{{ $supplier->supplier_company }}"
                    class="form-control" id="supplier_company" required>
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
                <label for="supplier_contact_number">Supplier Contact Number</label>
                <input type="text" name="supplier_contact_number" value="{{ $supplier->supplier_company }}"
                    class="form-control" id="supplier_contact_number" required>
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="text" name="supplier_registered_address"
                    value="{{ $supplier->supplier_registered_address }}" class="form-control"
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="text" name="supplier_communication_address"
                    value="{{ $supplier->supplier_communication_address }}" class="form-control"
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="text" name="supplier_gst_number" value="{{ $supplier->supplier_gst_number }}"
                    class="form-control" id="supplier_gst_number" required>
            </div>
        </div>
        <div class="col-md-12">
