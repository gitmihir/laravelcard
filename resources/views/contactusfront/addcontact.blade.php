    ...
    <div class="row mb-3 ml-3 mr-3 mt-3">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input id="sg_contact_title" onblur="validateInputText(this);" name="sg_contact_title" type="text"
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input id="sg_contact_email" onblur="validateEmail(this);" name="sg_contact_email" type="email"
                    required="required" class="form-control">
            </div>
        </div>
        <div class="col-md-6">
